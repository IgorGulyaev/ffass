...
class Bc_Brand_Block_Adminhtml_Brand_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_formScripts[] = "
            function toggleEditor() {
                if (tinyMCE.getInstanceById('mbrand_content') == null) {
    ...
    public function getHeaderText()
    {
        if( Mage::registry('brand_data') && Mage::registry('brand_data')->getId() ) {
            return Mage::helper('brand')->__("Edit Brand"); //'%s'", $this->htmlEscape(Mage::registry('manufacturer_data')->getMenufecturerName()));
        } else {
