        ...
        protected function _prepareForm()
        {
            ...
            if(Mage::registry('manufacturer_data')->getData('filename')!=""){
                $fieldset->addField('filename', 'file', array(
                        ...
                        'required'  => false,
                        'name'      => 'filename',
                        'after_element_html' => Mage::registry('manufacturer_data')->getData('filename') != "" ? '<span class="hint"><img src="'.Mage::getBaseUrl('media')."Manufacturer/".Mage::registry('manufacturer_data')->getData('filename').'" width="25" height="25" name="manufacturer_image" style="vertical-align: middle;" /><span style="color: #eb5e00; font-size: 1.25em;">Please use images with transparent background only !</span></span>':'',
                    ));
            }else{
                $fieldset->addField('filename', 'file', array(
                        'label'     => Mage::helper('manufacturer/data')->__('Brand Logo'),
