...
class Softprodigy_Giftwrap_Block_Adminhtml_Giftwrap_Renderer_Image extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract{
   public function render(Varien_Object $row)   {
		$html = '<img style="width:120px;" id="' . $this->getColumn()->getId() . '"
