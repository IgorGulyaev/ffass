...
class Belvg_FacebookFree_Model_Request extends Varien_Object
{
    ...
    const FB_USER_URL = 'https://graph.facebook.com/%s?%saccess_token=%s';
    const FB_USER_FIELDS = 'fields=id%2Cfirst_name%2Clast_name%2Cemail%2Cgender&';
    ...
    {
        $url = sprintf(self::FB_USER_URL, $fb_id, self::FB_USER_FIELDS, $this->getToken());
